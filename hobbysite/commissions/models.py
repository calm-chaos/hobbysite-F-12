...
class Commission(models.Model):
    ...
    status = models.CharField(
        max_length=255,
        choices=status_choices_commission,
        default=status_choices_commission[status_open],
    )
    ...
    author = models.ForeignKey(
        Profile, on_delete=models.CASCADE, related_name="authored_commission", default=1
    )
...
class Job(models.Model):
    ...
    status = models.CharField(
        max_length=255,
        choices=status_choices_job,
        default=status_choices_job[status_open],
    )
...
class JobApplication(models.Model):
    ...
    job = models.ForeignKey(
        "Job", on_delete=models.CASCADE, related_name="jobapplication"
    )

    applicant = models.ForeignKey(
        Profile, on_delete=models.CASCADE, related_name="applicantprofile"
    )

    status = models.CharField(
        max_length=255,
        choices=status_choices_jobapplication,
        default=status_choices_jobapplication[status_pending],
    )
